...
|---|---|---|---|---|
| **P1** | **First Session** | **$49** | One-time, **one per student** | A discounted first 60-minute 1:1 session, shaped to a stated purpose, plus pre-session preparation and post-session materials. |
...
later unlocks their own at that point. It is the offer that explains $49 against the $75 single
...
**Paid ads to the $49 First Session** and **short-form social content** (math explainers funnelling
to the same offer).
...
1. **The $49 tripwire only works if CAC lands well under it**, and that is unproven. If paid CAC
   exceeds ~$49, First Session stops being an acquisition offer and becomes a loss leader that only
