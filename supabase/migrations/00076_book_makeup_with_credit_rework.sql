-- Migration 00076: Rework book_makeup_with_credit RPC
-- The old RPC referenced the dropped `makeup_sessions` table.
-- New version works with regular class slots (host_class_id + session_date).

-- Drop old signature (different parameter names)
