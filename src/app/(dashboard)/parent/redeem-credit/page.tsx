...
import type { Subject, CourseLevel } from '@/lib/types';
import Link from 'next/link';

export default async function ParentRedeemCreditPage({
  searchParams,
}: {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          ...
          <Link href="/parent" className="text-sm font-medium text-navy-900 hover:text-navy-700">
            Back to Dashboard
          </Link>
        </div>
      </div>
